package fl.video
{
   ...
   public class FLVPlayback extends Sprite
   {
      ...
      public function setSize(param1:Number, param2:Number) : void
      {
         ...
         {
            if((_loc6_ = this.videoPlayers[_loc5_]) != null)
            {
      ...
      public function play(param1:String = null, param2:Number = NaN, param3:Boolean = false) : void
      {
         ...
         if(param1 == null)
         {
            ...
            {
               (_loc5_ = this.videoPlayers[this._activeVP]).play();
            }
         }
         else
         {
      ...
      public function seekToPrevNavCuePoint(param1:Number = NaN) : void
      {
         ...
         if(isNaN(param1) || param1 < 0)
         {
            param1 = (_loc4_ = this.videoPlayers[this._activeVP]).playheadTime;
         }
      ...
      public function addASCuePoint(param1:*, param2:String = null, param3:Object = null) : Object
      {
         ...
         return (_loc4_ = this.cuePointMgrs[this._activeVP]).addASCuePoint(param1,param2,param3);
      }
      ...
      override public function set height(param1:Number) : void
      {
         ...
         {
            if((_loc5_ = this.videoPlayers[_loc4_]) != null)
            {
      ...
      private function doContentPathConnect(param1:*) : void
      {
         ...
         if(!(_loc4_ = this.videoPlayerStates[_loc2_]).isWaiting)
         {
            return;
         }
      ...
      flvplayback_internal function skinLoaded() : void
      {
         ...
         else
         {
            ...
            this.skinShowTimer = new Timer(flvplayback_internal::DEFAULT_SKIN_SHOW_TIMER_INTERVAL,1);
      ...
      flvplayback_internal function queueCmd(param1:VideoPlayerState, param2:Number, param3:Number = NaN) : void
      {
         ...
         param1.cmdQueue.push(new QueuedCommand(param2,null,false,param3,NaN,NaN));
      }
      ...
      public function assignTabIndexes(param1:int) : int
      {
         ...
         return int(this.uiMgr.assignTabIndexes(param1));
      }
