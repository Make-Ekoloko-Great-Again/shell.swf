package fl.video
{
   ...
   public class VideoPlayer extends Video
   {
      ...
      public function play(param1:String = null, param2:Number = NaN, param3:Boolean = false, param4:Number = NaN, param5:Number = NaN) : void
      {
         if(param1 != null)
         {
            ...
            else
            {
               ...
               {
                  this.queueCmd(QueuedCommand.PLAY,param1,param3,param2,param4,param5);
                  return;
               }
               this.execQueuedCmds();
            }
            this._autoPlay = true;
            this._load(param1,param2,param3,param4,param5);
            return;
         }
         if(!this.isXnOK())
         {
         ...
         switch(this._state)
         {
            case VideoState.BUFFERING:
               ...
               {
                  this._play(this.segmentStartTime,this.segmentDuration);
                  if(this._atEnd)
                  {
                     this._atEnd = false;
                     this._currentPos = 0;
            ...
            case VideoState.STOPPED:
               ...
               else
               {
                  ...
                  {
                     this._atEnd = false;
                     this._seek(this.segmentStartTime);
                     this._state = VideoState.BUFFERING;
                     this.setState(VideoState.REWINDING);
                  }
      ...
      public function load(param1:String, param2:Number = NaN, param3:Boolean = false, param4:Number = NaN, param5:Number = NaN) : void
      {
         if(param1 == null)
         {
         ...
         else
         {
            if(!this.stateResponsive && this._state != VideoState.DISCONNECTED && this._state != VideoState.CONNECTION_ERROR)
            {
               this.queueCmd(QueuedCommand.LOAD,param1,param3,param2,param4,param5);
               return;
            }
            this.execQueuedCmds();
         }
      ...
      flvplayback_internal function _load(param1:String, param2:Number, param3:Boolean, param4:Number, param5:Number) : void
      {
         ...
         this.totalProgressTime = NaN;
         this._httpDoSeekCount = 0;
         this.segmentStartTime = param4;
         if(this.segmentStartTime >= 0 && !this._isLive)
         {
            this.segmentDuration = param5;
            if(isNaN(this.segmentDuration) || this.segmentDuration < 0)
            {
               this.segmentDuration = -1;
            }
         }
         ...
         var _loc6_:Boolean = this._ncMgr.connectToURL(this._contentPath);
         this.setState(VideoState.LOADING);
         this._cachedState = VideoState.LOADING;
         if(_loc6_)
         {
      ...
      public function stop() : void
      {
         ...
         if(this._ncMgr.isRTMP)
         {
            ...
            {
               this._currentPos = 0;
               this._play(this.segmentStartTime,0);
      ...
      public function seek(param1:Number) : void
      {
         ...
         if(!this._ncMgr.isRTMP)
         {
            if(this.segmentDuration > 0 && param1 > this.segmentDuration)
            {
               if(this._atEnd)
               {
                  return;
               }
               param1 = this.segmentDuration;
               this.segmentEndSeek = true;
            }
            if(this.segmentStartTime > 0)
            {
               param1 += this.segmentStartTime;
            }
         }
         switch(this._state)
         {
      ...
      public function get playheadTime() : Number
      {
         ...
         if(this.segmentStartTime > 0 && this._ncMgr != null && !this._ncMgr.isRTMP)
         {
            _loc1_ -= this.segmentStartTime;
         }
         return _loc1_;
      }
      ...
      flvplayback_internal function rtmpNetStatus(param1:NetStatusEvent) : void
      {
         ...
         switch(param1.info.code)
         {
            ...
            case "NetStream.Play.StreamNotFound":
               this.lastNetStreamError = param1.info.code;
               this.closeNS(false);
      ...
      flvplayback_internal function httpNetStatus(param1:NetStatusEvent) : void
      {
         ...
         switch(e.info.code)
         {
            ...
            case "NetStream.Seek.InvalidTime":
               if(this.segmentEndSeek)
               {
                  if(this._cachedState == VideoState.BUFFERING)
                  {
                     this._pause(false);
                  }
                  this.segmentEndSeek = false;
            ...
            case "NetStream.Play.FileStructureInvalid":
            case "NetStream.Play.NoSupportedTrackFound":
               this.lastNetStreamError = e.info.code;
               this.setState(VideoState.CONNECTION_ERROR);
         }
      }
      ...
      flvplayback_internal function setState(param1:String, param2:Boolean = true) : void
      {
         ...
         switch(this._cachedState)
         {
            case VideoState.REWINDING:
               ...
               if(this._ncMgr.isRTMP && _loc3_ == VideoState.STOPPED && this._closeRTMPStreamOnComplete)
               {
                  this.closeNS();
               }
         }
      ...
      flvplayback_internal function httpDoSeek(param1:TimerEvent) : void
      {
         ...
         if(this.segmentEndSeek)
         {
            ...
            {
               this._cachedState = VideoState.STOPPED;
            }
         }
         this.setStateFromCachedState(false);
         if(this._invalidSeekTime)
      ...
      flvplayback_internal function _play(param1:Number = 0, param2:Number = -1) : void
      {
         this.waitingForEnough = false;
         this._rtmpDoStopAtEndTimer.reset();
      ...
      flvplayback_internal function doAutoResize(param1:TimerEvent = null) : void
      {
         ...
         if(this._autoResizeTimer.running)
         {
            ...
            if(!(super.videoWidth != this._prevVideoWidth || super.videoHeight != this._prevVideoHeight || this._bufferState == flvplayback_internal::BUFFER_FULL || this._bufferState == flvplayback_internal::BUFFER_FLUSH || this._ns.time > this.autoResizePlayheadTimeout || this._state == VideoState.PAUSED))
            {
               return;
            }
      ...
      flvplayback_internal function _setUpStream() : void
      {
         ...
         this._hiddenForResizeMetadataDelay = 0;
         this._play(!!this._ncMgr.isRTMP ? Number(this.segmentStartTime) : Number(0));
      ...
      flvplayback_internal function execQueuedCmds() : void
      {
         ...
         if(this._cmdQueue.length > 0)
         {
            ...
            {
               §§pop();
               §§push(this.stateResponsive || this._state == VideoState.DISCONNECTED || this._state == VideoState.CONNECTION_ERROR);
            }
         }
            ...
            try
            {
               ...
               switch(nextCmd.type)
               {
                  case QueuedCommand.PLAY:
                     this.play(nextCmd.url,nextCmd.time,nextCmd.isLive,nextCmd.startTime,nextCmd.duration);
                     break;
                  case QueuedCommand.LOAD:
                     this.load(nextCmd.url,nextCmd.time,nextCmd.isLive,nextCmd.startTime,nextCmd.duration);
                     break;
      ...
      flvplayback_internal function queueCmd(param1:Number, param2:String = null, param3:Boolean = false, param4:Number = NaN, param5:Number = NaN, param6:Number = NaN) : void
      {
         this._cmdQueue.push(new QueuedCommand(param1,param2,param3,param4,param5,param6));
      }
   }
}
